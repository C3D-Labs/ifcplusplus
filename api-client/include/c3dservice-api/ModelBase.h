...
public:
    ...
    static web::json::value toJson( const std::vector<std::shared_ptr<utility::string_t>>& val );    
    template<typename T>
    ...
    static bool fromJson( const web::json::value& val, std::vector<std::shared_ptr<utility::string_t>>& );    
    template<typename T>
